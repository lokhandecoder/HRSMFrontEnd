...
export async function GetApplyLeaveById(
  appliedLeaveTypeId: number
): Promise<{ data: LeaveFormData }> {
  try {
    const response = await axios.get<{ data: LeaveFormData }>(
      `${API_URL}appliedLeave/GetAppliedLeaveByIdAsync/${appliedLeaveTypeId}`,
      {
        headers: {
...
export async function createLeaveApply(leaveForm: LeaveFormData): Promise<any> {
  try {
    const response = await axios.post(
      `${API_URL}appliedLeave/CreateAppliedLeaveAsync`,
      leaveForm,
      {
        headers: {
          Authorization: `Bearer ${TokenByLocalStorage}`,
    ...
    if (error.response && error.response.data && error.response.data.errors) {
      const leaveReasonError = error.response.data.errors.LeaveReason[0];
      console.log("Leave Reason Error:", leaveReasonError);
      return { error: leaveReasonError };
    } else {
...
export async function updateLeaveApply(
  ...
  try {
    const response = await axios.put(
      `${API_URL}appliedLeave/UpdateAppliedLeaveAsync/${id}`,
      leaveForm,
      {
        headers: {
          Authorization: `Bearer ${TokenByLocalStorage}`,
...
export async function SendLeaveReminder(id: number): Promise<any> {
  try {
    const response = await axios.post(
      `${API_URL}appliedLeave/SendLeaveReminder/${id}`,
      {
        headers: {
          Authorization: `Bearer ${TokenByLocalStorage}`,
        },
...
export async function GetAppliedLeavesAsync(): Promise<any> {
  try {
    const response = await axios.get(
      `${API_URL}appliedLeave/GetAppliedLeavesAsync`,
      {
        headers: {
          Authorization: `Bearer ${TokenByLocalStorage}`,
        },
...
export async function GetAppliedLeavesByEmpIdAsync(): Promise<any> {
  try {
    ...
    const response = await axios.get(
      `${API_URL}appliedLeave/GetAppliedLeavesByEmpIdAsync/${empID}`,
      {
        headers: {
          Authorization: `Bearer ${TokenByLocalStorage}`,
        },
...
export async function GetAppliedLeavesByReportingPersonIdAsync(
  ...
  try {
    ...
    // const response = await axios.get(`${API_URL}appliedLeave/GetAppliedLeavesByReportingPersonIdAsync/${empID}`);
    const response = await axios.get(
      `${API_URL}appliedLeave/GetAppliedLeavesByReportingPersonIdAsync/${reportingPersonId}`,
      {
        headers: {
          Authorization: `Bearer ${TokenByLocalStorage}`,
        },
...
export async function updateLeaveStatus(
  ...
  try {
    const response = await axios.put(
      `${API_URL}UpdateAppliedLeaveAsync/${id}`,
      leaveForm,
      {
        headers: {
          Authorization: `Bearer ${TokenByLocalStorage}`,
...
export async function UpdateIsRejectedAsync(
  appliedLeaveTypeId: number,
  isRejected: boolean
): Promise<any> {
  try {
    const response = await axios.get(
      `${API_URL}AppliedLeave/UpdateIsRejectedAsync/${appliedLeaveTypeId}/${isRejected}`,
      {
        headers: {
          Authorization: `Bearer ${TokenByLocalStorage}`,
        },
...
export async function UpdateIsApprovedAsync(
  appliedLeaveTypeId: number,
  isApproved: boolean
): Promise<any> {
  try {
    const response = await axios.get(
      `${API_URL}AppliedLeave/UpdateIsApprovedAsync/${appliedLeaveTypeId}/${isApproved}`,
      {
        headers: {
          Authorization: `Bearer ${TokenByLocalStorage}`,
        },
...
export async function UpdateIsApprovedCancelAsync(
  appliedLeaveTypeId: number,
  isApproved: boolean
): Promise<any> {
  try {
    const response = await axios.put(
      `${API_URL}AppliedLeave/UpdateIsApprovedCancelAsync/${appliedLeaveTypeId}/${isApproved}`,
      {
        headers: {
          Authorization: `Bearer ${TokenByLocalStorage}`,
        },
...
export async function AppliedLeaveUpdateStatusAsync(
  updateStatus: AppliedLeaveUpdateStatus
): Promise<any> {
  try {
    const response = await axios.post(
      `${API_URL}appliedLeave/AppliedLeaveUpdateStatusAsync`,
      updateStatus,
      {
        headers: {
          Authorization: `Bearer ${TokenByLocalStorage}`,
...
export async function AppliedLeaveUpdateStatusByEmailAsync(
  code: string
): Promise<any> {
  try {
    const response = await axios.get(
      `${API_URL}AppliedLeave/AppliedLeaveUpdateStatusByEmailAsync/${code}`,
      {
        headers: {
          Authorization: `Bearer ${TokenByLocalStorage}`,
        },
...
export async function AppliedLeaveUpdateStatusByEmailConfirmAsync(
  dataObject: LeaveUpdateData
) {
  try {
...
export async function DeleteAppliedLeaveByIdAsync(
  id: number
): Promise<{ data: any }> {
  try {
    const response = await axios.delete(
      `${API_URL}appliedLeave/DeleteAppliedLeaveByIdAsync/${id}`,
      {
        headers: {
          Authorization: `Bearer ${TokenByLocalStorage}`,
        },
